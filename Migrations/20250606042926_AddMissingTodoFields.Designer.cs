...
namespace TodoListApi.Migrations
{
    ...
    [Migration("20250606042926_AddMissingTodoFields")]
    partial class AddMissingTodoFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TodoListApi.Models.TodoItem", b =>
                {
                    ...
                    b.HasIndex("CompletedDate")
                        .HasDatabaseName("IX_Todos_CompletedDate");
                    ...
                    b.HasIndex("UserId", "CompletedDate")
                        .HasDatabaseName("IX_Todos_UserId_CompletedDate");

                    b.HasIndex("UserId", "CreatedDate")
                        .HasDatabaseName("IX_Todos_UserId_CreatedDate");
                    ...
                    b.HasIndex("UserId", "Title", "Description")
                        .HasDatabaseName("IX_Todos_UserId_Search");
